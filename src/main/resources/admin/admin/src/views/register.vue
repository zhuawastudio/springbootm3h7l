      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='huiyuan'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.huiyuandianhua" class="input" type="text" placeholder="会员电话">
			   </div>
			 </div> -->
			<el-form-item label="会员电话" class="input" v-if="tableName=='huiyuan'">
			  <el-input v-model="ruleForm.huiyuandianhua" autocomplete="off" placeholder="会员电话"  />
			</el-form-item>
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if(`huiyuan` == this.tableName && this.ruleForm.huiyuandianhua&&(!this.$validate.isMobile(this.ruleForm.huiyuandianhua))){
        this.$message.error(`会员电话应输入手机格式`);
        return
      }
      this.$http({
        url: url,
