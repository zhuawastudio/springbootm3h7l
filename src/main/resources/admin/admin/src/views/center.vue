  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='huiyuan'"  label="会员电话" prop="huiyuandianhua">
          <el-input v-model="ruleForm.huiyuandianhua"               placeholder="会员电话" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">  
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if( 'huiyuan' ==this.flag && this.ruleForm.huiyuandianhua&&(!isMobile(this.ruleForm.huiyuandianhua))){
